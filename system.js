...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('system')
        .setDescription('Thông tin máy và lồn gì đó etc'),
    async execute(interaction) {
        try {
            ...
            await interaction.reply({
                content: '❌ Lỗi Mẹ nó API còn gửi ảnh rồi.',
                ephemeral: true
            });
        }
    },
};
//npm i axios;npm i systeminformation
