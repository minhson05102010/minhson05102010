...
async function onCall({ message, args, extra, getLang }) {
    ...
    try {
        ...
        // Quyết định thị trường tăng hay giảm
        const marketTrend = Math.random() > 0.5 ? "up" : "down"; // "up" là xanh, "down" là đỏ
        ...
        // Gửi hình ảnh biểu thị thị trường
...
//!chungkhoan TSLA mua: Mua cổ phiếu Tesla.
//!chungkhoan NFLX bán: Bán cổ phiếu Netflix.
